...
void BOARD_GPIO_Configuration(void)
{
    ...
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_2MHz;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
    GPIO_Init(PORT_LED_IR, &GPIO_InitStructure);

    /************************************************/
    /*  Pin for alarm enable                        */
    /************************************************/

    GPIO_InitStructure.GPIO_Pin = PIN_ALARM_EN;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_2MHz;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;
    GPIO_Init(PORT_ALARM_EN, &GPIO_InitStructure);
    ...
    GPIO_InitStructure.GPIO_Pin = PIN_IR_INT;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_2MHz;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;
    GPIO_Init(PORT_IR_INT, &GPIO_InitStructure);
}
