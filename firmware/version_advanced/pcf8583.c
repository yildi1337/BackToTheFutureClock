...
/* Use another free RAM registers for the last DCF77 update date/time */
#define PCF8583_REGISTER_RAM_DCF77_MONTH     0x11
#define PCF8583_REGISTER_RAM_DCF77_DAY       0x12
#define PCF8583_REGISTER_RAM_DCF77_YEAR      0x13
#define PCF8583_REGISTER_RAM_DCF77_HOUR      0x14
#define PCF8583_REGISTER_RAM_DCF77_MINUTE    0x15

/* Use another free RAM registers for the alarm date/time */
#define PCF8583_REGISTER_RAM_ALARM_MONTH     0x16
#define PCF8583_REGISTER_RAM_ALARM_DAY       0x17
#define PCF8583_REGISTER_RAM_ALARM_YEAR      0x18
#define PCF8583_REGISTER_RAM_ALARM_HOUR      0x19
#define PCF8583_REGISTER_RAM_ALARM_MINUTE    0x1A
...
/**
 * Gets the last DCF77 update time saved in PCF8583s additional RAM.
 */
void PCF8583_GetLastDCF77UpdateDateTime(DATETIME_PCF8583_t * p_pDateTime)
{
    uint8_t readBuf[5] = { 0 };
    uint8_t interruptEnabledBefore = m_InterruptEnabled;
    ...
    /* Read from RTC */
    I2Cx_ReadBuffer(PCF8583_I2CBUS, PCF8583_I2C_ADDRESS, PCF8583_REGISTER_RAM_DCF77_MONTH, readBuf, 5);

    if (interruptEnabledBefore)
        PCF8583_InterruptEnable();

    p_pDateTime->month = readBuf[0];
    p_pDateTime->day = readBuf[1];
    p_pDateTime->year = readBuf[2];
    p_pDateTime->hour = readBuf[3];
    p_pDateTime->minute = readBuf[4];
}

/**
 * Sets the last DCF77 update time to the PCF8583s additional RAM.
 */
void PCF8583_SetLastDCF77UpdateDateTime(DATETIME_PCF8583_t * p_pDateTime)
{
    uint8_t interruptEnabledBefore = m_InterruptEnabled;
    ...
    I2Cx_WriteByte(PCF8583_I2CBUS, PCF8583_I2C_ADDRESS, PCF8583_REGISTER_RAM_DCF77_MONTH, p_pDateTime->month);
    I2Cx_WriteByte(PCF8583_I2CBUS, PCF8583_I2C_ADDRESS, PCF8583_REGISTER_RAM_DCF77_DAY, p_pDateTime->day);
    I2Cx_WriteByte(PCF8583_I2CBUS, PCF8583_I2C_ADDRESS, PCF8583_REGISTER_RAM_DCF77_YEAR, p_pDateTime->year);
    I2Cx_WriteByte(PCF8583_I2CBUS, PCF8583_I2C_ADDRESS, PCF8583_REGISTER_RAM_DCF77_HOUR, p_pDateTime->hour);
    I2Cx_WriteByte(PCF8583_I2CBUS, PCF8583_I2C_ADDRESS, PCF8583_REGISTER_RAM_DCF77_MINUTE, p_pDateTime->minute);
...
/**
 * Gets the alarm time saved in PCF8583s additional RAM.
 */
void PCF8583_GetAlarmDateTime(DATETIME_PCF8583_t * p_pDateTime)
{
    uint8_t readBuf[5] = { 0 };
    uint8_t interruptEnabledBefore = m_InterruptEnabled;
    ...
    /* Read from RTC */
    I2Cx_ReadBuffer(PCF8583_I2CBUS, PCF8583_I2C_ADDRESS, PCF8583_REGISTER_RAM_ALARM_MONTH, readBuf, 5);
...
/**
 * Sets the alarm time saved in PCF8583s additional RAM.
 */
void PCF8583_SetAlarmDateTime(DATETIME_PCF8583_t * p_pDateTime)
{
    uint8_t interruptEnabledBefore = m_InterruptEnabled;
    ...
    I2Cx_WriteByte(PCF8583_I2CBUS, PCF8583_I2C_ADDRESS, PCF8583_REGISTER_RAM_ALARM_MONTH, p_pDateTime->month);
    I2Cx_WriteByte(PCF8583_I2CBUS, PCF8583_I2C_ADDRESS, PCF8583_REGISTER_RAM_ALARM_DAY, p_pDateTime->day);
    I2Cx_WriteByte(PCF8583_I2CBUS, PCF8583_I2C_ADDRESS, PCF8583_REGISTER_RAM_ALARM_YEAR, p_pDateTime->year);
    I2Cx_WriteByte(PCF8583_I2CBUS, PCF8583_I2C_ADDRESS, PCF8583_REGISTER_RAM_ALARM_HOUR, p_pDateTime->hour);
    I2Cx_WriteByte(PCF8583_I2CBUS, PCF8583_I2C_ADDRESS, PCF8583_REGISTER_RAM_ALARM_MINUTE, p_pDateTime->minute);
