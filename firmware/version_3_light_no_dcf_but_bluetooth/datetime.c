...
/**
 * Converts date/time from PCF8583 type to display type.
 */
...
/**
 * Converts date/time from display type to PCF8583 type.
 */
...
/**
 * Returns the difference between two display date/times in seconds.
 */
